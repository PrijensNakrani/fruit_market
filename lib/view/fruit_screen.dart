...
import 'package:fruit_market/widget/text_16.dart';
import 'package:fruit_market/widget/text_size.dart';
import 'package:get/get.dart';
import 'package:shimmer/shimmer.dart';

import '../service/favourite_controller.dart';
import 'detail_screen.dart';

class FruitScreen extends StatelessWidget {
  final searchText;
  final tabSelected;
  const FruitScreen({Key? key, this.searchText, this.tabSelected})
      : super(key: key);
